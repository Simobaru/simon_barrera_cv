# Lista de Tareas - Mejora CV Digital

- [ ] Analizar `pasted_content_3.txt` para extraer nueva información
- [ ] Actualizar `es.json` y `en.json` con la información enriquecida
- [ ] Mejorar `Hero3D.tsx` para que reaccione a la posición del mouse
- [ ] Añadir animaciones de entrada más dinámicas en secciones clave
- [ ] Configurar botón de descarga de CV (mover archivo a public)
